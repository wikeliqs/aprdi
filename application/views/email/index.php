...
<head>
	...
	<?php include APPPATH.'views/frontend/default/includes_top.php';?>
...
<body class="gray-bg">
	...
	if ($this->session->userdata('user_login')) {
		include APPPATH.'views/frontend/default/logged_in_header.php';
	}else {
		include APPPATH.'views/frontend/default/logged_out_header.php';
	}  
	// echo "<div class='wrap'>";
	...
	<?php
	include APPPATH.'views/frontend/default/footer.php';
	include APPPATH.'views/frontend/default/includes_bottom.php';
	include APPPATH.'views/frontend/default/modal.php';
	?>
