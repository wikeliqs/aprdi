                ...
                <div class="row">
                    <div class="col">
                        <nav class="navbar navbar-expand-lg navbar-light bg-light ">
                            ...
                            <a href="<?php echo site_url(''); ?>" class="navbar-brand" href="#"><img src="<?php echo base_url().'assets/frontend/img/aprdi.png'; ?>" alt="" height="30"></a>
                            ...
                            <div class="sign-in-box btn-group">
                                ...
                                <button type="button" class="btn btn-sign-up"  onclick="window.location.href='<?php echo site_url('home/signup'); ?>'" ><?php echo get_phrase('sign_up'); ?></button>
