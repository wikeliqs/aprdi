                                        ...
                                        <div class="message-sender-head clearfix">
                                            <div class="message-sender-info d-inline-block">
                                                <div class="sender-image d-inline-block">
                                                    <img src="<?php echo base_url().'uploads/user_image/'.$user_to_show_id.'.jpg';?>" alt="" class="img-fluid">
                                                </div>
                        ...
                        <div class="message-body">
                            <div class="form-group">
                                <select class="form-control select2" name = "reciever">
                                    <option value="<?php echo $admin_details['id']; ?>"><?php echo $admin_details['first_name'].' '.$admin_details['last_name']; ?></option>
                                </select>
                            </div>
                            <div class="form-group">
