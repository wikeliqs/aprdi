        ...
        <div class="row">
            ...
            <div class="col-md-4 d-flex">
                <div class="home-fact-box mr-md-auto ml-auto mr-auto">
                    ...
                    <div class="text-box">
                        <h4><?php echo $courses->num_rows().' '.get_phrase('online_courses'); ?></h4>
                            ...
                            <a href="<?php echo site_url('home/course/'.slugify($top_course['title']).'/'.$top_course['id']); ?>" class="has-popover">
                                <div class="course-box">
                                    ...
                                    <div class="course-image">
                                        <img src="<?php echo base_url().'uploads/thumbnails/course_thumbnails/'.$top_course['id'].'.jpg'; ?>" alt="" class="img-fluid">
                                    </div>
                                    <div class="course-details">
                                        ...
                                        <?php if ($top_course['discount_flag'] == 1): ?>
                                            <p class="price text-right"><small><?php echo 'Rp. '.$top_course['price']; ?></small><?php echo 'Rp. '.$top_course['discounted_price']; ?></p>
                                        <?php else: ?>
                                            <p class="price text-right"><?php echo 'Rp. '.$top_course['price']; ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </a>
                            ...
                            <div class="webui-popover-content">
                                <div class="course-popover-content">
                                    ...
                                    <div class="course-title">
                                        <a href=""><?php echo $top_course['title']; ?></a>
                                    </div>
                                	...
                                	<div class="popover-btns">
                                        <?php if (is_purchased($top_course['id'])): ?>
                                            <div class="purchased">
                                                <a href="#"><?php echo get_phrase('already_purchased'); ?></a>
                                            </div>
                                        <?php else: ?>
                  ...
                  <?php
                    ...
                    <div class="course-box-wrap">
                        <a href="<?php echo site_url('home/course/'.slugify($latest_course['title']).'/'.$latest_course['id']); ?>">
                            <div class="course-box">
                                <div class="course-image">
                                    <img src="<?php echo base_url().'uploads/thumbnails/course_thumbnails/'.$latest_course['id'].'.jpg'; ?>" alt="" class="img-fluid">
                                </div>
                                <div class="course-details">
                                    ...
                                    <?php if ($latest_course['discount_flag'] == 1): ?>
                                      <p class="price text-right"><small><?php echo 'Rp.'.$latest_course['price']; ?></small><?php echo 'Rp.'.$latest_course['discounted_price']; ?></p>
                                    <?php else: ?>
                                      <p class="price text-right"><?php echo 'Rp.'.$latest_course['price']; ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </a>
