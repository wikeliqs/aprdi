...
<section class="menu-area">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light ">
                      ...
                      <li><a class="mobile-search-trigger" href="#mobile-search">Search<span></span></a></li>
                        ...
                        <a href="<?php echo site_url(''); ?>" class="navbar-brand" href="#">
                            <img src="<?php echo base_url().'assets/frontend/img/aprdi.png'; ?>" alt="" height="30">
                        </a>
    ...
    </section><?php if($this->session->userdata('is_verify')==null){?>
<div class="container">
 <div class="alert alert-danger alert-dismissible fade show" role="alert">
  <strong><?php echo $this->session->userdata('email'); ?></strong> please verification your email .
