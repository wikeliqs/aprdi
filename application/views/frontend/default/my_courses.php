            ...
            <div class="col-lg-6">
                <div class="my-course-filter-bar filter-box">
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#"><?php echo $admin_details['first_name'].' '.$admin_details['last_name']; ?></a>
                            ...
                            <div class="course-box">
                                <a href="<?php echo site_url('home/lesson/'.slugify($course_details['title']).'/'.$my_course['course_id']); ?>">
                                    <div class="course-image">
                                        <img src="<?php echo base_url().'uploads/thumbnails/course_thumbnails/'.$my_course['course_id'].'.jpg'; ?>" alt="" class="img-fluid">
