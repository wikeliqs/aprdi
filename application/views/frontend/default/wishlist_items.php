                    ...
                    <li>
                        <div class="item clearfix">
                            <div class="item-image">
                                <a href="">
                                    <img src="<?php echo base_url().'uploads/thumbnails/course_thumbnails/'.$wishlist.'.jpg';?>" alt="" class="img-fluid">
                                </a>
                            </div>
                            <div class="item-details">
                                <a href="">
                                    ...
                                    <div class="instructor-name">
                                        <?php echo get_phrase('by').' '.$admin_details['first_name'].' '.$admin_details['last_name']; ?>
                                    </div>
                                    <div class="item-price">
                                        <?php if ($course_details['discount_flag'] == 1): ?>
                                            <span class="current-price"><?php echo '$'.$course_details['discounted_price']; ?></span>
                                            <span class="original-price"><?php echo '$'.$course_details['price']; ?></span>
                                        <?php else: ?>
                                            <span class="current-price"><?php echo '$'.$course_details['price']; ?></span>
                                        <?php endif; ?>
                                    </div>
                                </a>
