                ...
                <div class="row">
                    <div class="col-md-6">
                        <p class="copyright-text">
                            <a href=""><img src="<?php echo base_url().'assets/frontend/img/aprdi.png'; ?>" alt="" class="d-inline-block" width="110"></a>
                            by <a href="http://ticmi.co.id" target="_blank">TICMI</a>
                        </p>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content sign-in-modal">
                    <div class="modal-header">
                        <h5 class="modal-title"><?php echo get_phrase('Login elearning APRDI'); ?>!</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="account-have">
                            <?php echo get_phrase('do_not_have_an_account'); ?>? <a href="" data-toggle="modal" onclick="window.location.href='<?php echo site_url('home/signup'); ?>'" ><?php echo get_phrase('sign_up'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
