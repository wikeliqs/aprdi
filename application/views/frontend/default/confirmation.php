...
<div class="container   " style="margin-top:5%; ">
	<div class="row">
    <div class="col-sm-6 col-sm-offset-2" style="float: none;margin: 0 auto;"><!-- col -->
		<h2><h1>Check your email!</h1></h2>
        <p class="desc">We’ve sent a six-digit confirmation code to <strong id="email"><?php echo $email; ?></strong> <br> Enter it below to confirm your email address.</p>
        <br><br><br>
       <label><span class="normal">Your </span>confirmation code</label>
         <div class="confirmation_code split_input large_bottom_margin" data-multi-input-code="true">
    			<div class="confirmation_code_group">
					<div  class="split_input_item input_wrapper"><input onkeyup="this.value=this.value.replace(/[^\d]/,'')" id="code1" type="text" class="inline_input" maxlength="1"></div>
					<div  class="split_input_item input_wrapper"><input onkeyup="this.value=this.value.replace(/[^\d]/,'')" id="code2" type="text" class="inline_input" maxlength="1"></div>
					<div class="split_input_item input_wrapper"><input onkeyup="this.value=this.value.replace(/[^\d]/,'')" id="code3"  type="text" class="inline_input" maxlength="1"></div>
					<div class="split_input_item input_wrapper"><input onkeyup="this.value=this.value.replace(/[^\d]/,'')" id="code4"  type="text" class="inline_input" maxlength="1"></div>
					<div  class="split_input_item input_wrapper"><input onkeyup="this.value=this.value.replace(/[^\d]/,'')" id="code5" type="text" class="inline_input" maxlength="1"></div>
					<div  class="split_input_item input_wrapper"><input onkeyup="this.value=this.value.replace(/[^\d]/,'')" id="code6" type="text" class="inline_input" maxlength="1"></div>
					<div id="checkcode" class="split_input_item " style="border:0;padding-left: 14px;"></div>
				</div>

				 
			</div>
			<br> 
			 <p class="desc">if you don't get an email, please <a href="<?php echo site_url('login/resend_confirmation');?>" id="resend_email">resend</a> the confirmation email</p>
            </div><!-- endof col -->
    </div>
</div>
