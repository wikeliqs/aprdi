...
function showAjaxModal(url)
{
    ...
    jQuery('#modal_ajax .modal-body').html('<div style="text-align:center;margin-top:200px;"><img src="{{ base_url().'assets/backend/img/preloader.gif'}}" /></div>');
    ...
    <div class="modal fade" id="modal-generic_confirmation">
        <div class="modal-dialog">
            <div class="modal-content" style="margin-top:100px;">
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" style="text-align:center;">{{ get_phrase('are_you_sure_to_update_this_information') }} ?</h4>
                </div>


                <div class="modal-footer" style="margin:0px; border-top:0px; text-align:center;">
                    <a href="#" class="btn btn-danger" id="update_link">{{ get_phrase('yes') }}</a>
                    <button type="button" class="btn btn-info" data-dismiss="modal">{{ get_phrase('no') }}</button>
                </div>
            </div>
        </div>
    </div>
