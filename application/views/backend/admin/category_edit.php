			...
			<div class="panel-body">
                <form action="<?php echo site_url('admin/categories/edit/'.$category_id); ?>" method="post" role="form" class="form-horizontal form-groups-bordered">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('font').'-'.get_phrase('awesome class'); ?></label>

                            <div class="col-sm-5">
                                <input type="text" name = "font_awesome_class" class="form-control" required value="<?php echo $data['font_awesome_class']; ?>">
                            </div>
                        </div>
