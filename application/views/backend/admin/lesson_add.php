                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo site_url('admin/lessons/'.$course_id.'/add'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name = "duration" id = "duration" class="form-control durasi" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <button class = "btn btn-success" type="submit" name="button" onclick="ajax_get_video_details(jQuery('#video_url').val());"><?php echo get_phrase('add_lesson'); ?></button>
                            </div>
                        </div>
                    </form>
                </div>
