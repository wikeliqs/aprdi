    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                <div class="row">
                    <form class="" action="<?php echo site_url('admin/course_actions/edit/'.$course_id); ?>" method="post" enctype="multipart/form-data" novalidate>
                        <div class="col-md-7">
                                        ...
                                        <div class="panel-body">
                                            <div class="col-md-8 col-sm-8 col-xs-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea rows="5" class="form-control wysihtml5" data-stylesheet-url="<?php echo base_url('assets/backend/css/wysihtml5-color.css');?>"
                											...
                											id="sample_wysiwyg1" required><?php echo $course_details['description']; ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select class="form-control selectboxit" id="level" name="level">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-2 col-sm-2 col-xs-2"  style="margin-top: 24px; float: left; margin-left: 0; padding-left: 0;">
                                            <button type="button" class = "btn btn-xs btn-default" name="button" onclick="appendOutcome()"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="collapseFour" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="col-md-8 col-sm-8 col-xs-8">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-2"  style="margin-top: 24px; float: left; margin-left: 0; padding-left: 0;">
                                    <button type="button" class = "btn btn-xs btn-default" name="button" onclick="appendRequirement()"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="col-md-8 col-sm-8 col-xs-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="number" name = "discounted_price" id = "discounted_price" class="form-control" required onkeyup="calculateDiscountPercentage(this.value)" value="<?php echo $course_details['discounted_price']; ?>" min="0">
                                </div>
        ...
        <div class="form-group" style="margin-top: 34px;">
            <button class = "btn btn-success" type="submit" name="button"><?php echo get_phrase('update_course'); ?></button>
        </div>
    </div>
        ...
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-body">
                    ...
                    <div class="controls">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                                <img src="<?php echo base_url('uploads/thumbnails/course_thumbnails/'.$course_id.'.jpg');?>" alt="...">
                            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" name = "course_overview_url" class="form-control" required value="<?php echo $course_details['video_url'] ?>">
                    </div>
                </div>
            </div>
        </div>
